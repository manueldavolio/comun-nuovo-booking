...
export default function CalendarioAdmin() {
  ...
  const [payAmount, setPayAmount] = useState<string>(""); // euro
  const [payMethod, setPayMethod] = useState<"CASH" | "CARD">("CASH");
  const [detailErr, setDetailErr] = useState<string>("");

  function openDetail(b: Booking) {
    setDetailBooking(b);
    setPayAmount(b.total_amount_cents != null ? String((b.total_amount_cents / 100).toFixed(2)).replace(".", ",") : "");
    setPayMethod("CASH");
    setDetailErr("");
    setDetailOpen(true);
  }
    ...
    <div style={{ padding: 16 }}>
      <div style={{ maxWidth: 1600, margin: "0 auto" }}>
        ...
        <div style={{ marginTop: 8, opacity: 0.7, fontSize: 12 }}>
          ...
          {String(closeM).padStart(2, "0")} (step {STEP_MIN} min). • Click su uno slot vuoto per inserire prenotazione manuale.
        </div>
        ...
        {newOpen && (
          ...
          >
            <div
              ...
              style={{ width: 420, maxWidth: "100%", background: "white", borderRadius: 16, border: "1px solid #eee", padding: 16 }}
            >
        ...
        {detailOpen && detailBooking && (
          ...
          >
            <div
              onClick={(e) => e.stopPropagation()}
              style={{ width: 520, maxWidth: "100%", background: "white", borderRadius: 16, border: "1px solid #eee", padding: 16 }}
            >
